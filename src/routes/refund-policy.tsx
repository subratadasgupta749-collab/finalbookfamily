...
export const Route = createFileRoute("/refund-policy")({
  loader: () => getLegalPage({ data: { slug: "refund" } }),
  head: ({ loaderData }) => {
    const data = loaderData as LegalPageData | undefined;
    const seo = data?.seo ?? {
      metaTitle: "Refund Policy — My Family History Book",
      metaDescription: "30-day refund policy for digital books and physical print replacement guarantees.",
    };
    const canonical = seo.canonicalUrl || "https://myfamilyhistorybook.com/refund-policy";
    return {
      meta: [
        { title: seo.metaTitle || "Refund Policy — My Family History Book" },
