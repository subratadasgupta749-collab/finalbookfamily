...
export const Route = createFileRoute("/dmca")({
  loader: () => getLegalPage({ data: { slug: "dmca" } }),
  head: ({ loaderData }) => {
    const data = loaderData as LegalPageData | undefined;
    const seo = data?.seo ?? {
      metaTitle: "DMCA Policy — My Family History Book",
      metaDescription: "Official DMCA copyright infringement notice, counter-notification procedure, and designated agent details.",
    };
    const canonical = seo.canonicalUrl || "https://myfamilyhistorybook.com/dmca";
    return {
      meta: [
        { title: seo.metaTitle || "DMCA Policy — My Family History Book" },
